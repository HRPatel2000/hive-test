...
CREATE EXTERNAL TABLE IF NOT EXISTS dealer_hierarchy_delta
(
  file_name string,
  gen_id string,
  dms_system string,
...
TBLPROPERTIES ('serialization.null.format'='', 'numFiles'='20', 'STATS_GENERATED_VIA_STATS_TASK'='true', 'totalSize'='153086')
;
